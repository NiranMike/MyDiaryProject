...
function MidSection({openSignUp}) {
  return (
    <div className='w-full bg-white py-16 px-4'>
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
         ...
         <div className="flex flex-col justify-center">
          ...
          <button onClick={()=>openSignUp(true)} className=' bg-[#000] w-[200px] text-[#00df70] rounded-md font-medium mx-auto md:mx-0 py-3 mt-6'>Sign Up</button>
